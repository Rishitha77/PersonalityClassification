...
# Read in files
users <- read.csv(file = "C:/Users/ryedire/OneDrive - Arizona State University/Desktop/SWM/sample_dataset/users.csv")
likes <- read.csv(file = "C:/Users/ryedire/OneDrive - Arizona State University/Desktop/SWM/sample_dataset/likes.csv")
users_likes <- read.csv(file = "C:/Users/ryedire/OneDrive - Arizona State University/Desktop/SWM/sample_dataset/users-likes.csv")
